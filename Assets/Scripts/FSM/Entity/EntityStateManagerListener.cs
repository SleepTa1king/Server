...
[AddComponentMenu("PLAYERTWO/Platformer Project/Entity/EntityStateManagerListener")]
public class EntityStateManagerListener:MonoBehaviour
{
    ...
    protected EntityStateManagers m_manager;
    protected virtual void Start()
    {
        if(!m_manager)
        {
            m_manager = GetComponentInParent<EntityStateManagers>();
        }
