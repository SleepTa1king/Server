...
public class PlayerStats : EntityStats<PlayerStats>
{
    ...
    public float sliderForce = 10f;
    public float rotationSpeed = 970f;
    public float gravity = 38f;
    public float fallGrivity = 65f;
    public float gravityTopSpeed = 50f;


    [Header("Motion Stats")]
    public bool applySlopeFactor = true;    //坡度因子
    public float acceleration = 13f;        //加速度
    public float deceleration = 13f;        //减速度
    ...
    public float brakeTreshold = -0.8f;     //刹车判定阈值
    public float slopeUpwardForce = 25f;    //上坡额外阻力
    public float slopeDownwardForce = 28f;  //下坡额外阻力

    [Header("Jump Stats")]
    public int multiJumps = 1;
    public float coyoteJumpThreshold = 0.15f;
    public float maxJumpHeight = 17f;
    public float minJumpHeight = 17f;
    ...
    public float crawlingAccleration = 8f;
